...
const CategoryCard: React.FC<CategoryCardProps> = ({ 
  ...
  const progressPercentage = Math.round((category.completedMissions / category.totalMissions) * 100);
  const level = Math.floor(category.xp / 500) + 1;
              ...
              <View style={styles.rightSection}>
                ...
                <View style={styles.missionsContainer}>
                  <Text style={styles.missionsText}>
                    <Text style={styles.completedMissions}>{category.completedMissions}</Text>
                    <Text style={styles.totalMissions}>/{category.totalMissions}</Text>
                  </Text>
