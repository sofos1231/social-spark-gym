	...
	theme: {
		...
		extend: {
			...
			boxShadow: {
				...
				'glow-orange-intense': 'var(--shadow-glow-orange-intense)',
				'glow-purple-intense': 'var(--shadow-glow-purple-intense)',
			...
			animation: {
				...
				'particle-explode': 'particle-explode 1.2s ease-out',
				'xp-burst': 'xp-burst 0.8s cubic-bezier(0.68, -0.55, 0.265, 1.55)',
				'ring-expand': 'ring-expand 1s ease-out',
				'fade-in-up': 'fade-in-up 0.5s ease-out',
				'flow-active': 'flow-active 2s linear infinite',
